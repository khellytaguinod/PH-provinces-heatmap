...
## Run & Test Locally
1. Open index.js and paste in the ```js let sheetID = "spreadsheetIDhere"; ```  with the ID from your duplicated spreadsheet. ( [need help with the ID?](https://developers.google.com/sheets/api/guides/concepts) ) 
